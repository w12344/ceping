...
def upload_record_to_oss(record):
    ...
    try:
        ...
        print(f"[OSS] FTH Boss Report uploaded to: {object_key}")
    except Exception as e:
        print(f"[OSS Error] Failed to upload FTH Boss report: {e}")
