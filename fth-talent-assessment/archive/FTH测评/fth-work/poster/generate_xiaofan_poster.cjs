...
const OUT = "/Users/chenpan/Documents/Codex/2026-06-09/fighter-runner-climber-thinker-analyzer-builder/outputs/FTH职业特质测评-小凡-海报.svg";
const URL = "https://fth.msrtai.com";
...
<svg xmlns="http://www.w3.org/2000/svg" width="1080" height="1440" viewBox="0 0 1080 1440">
  ...
  <text x="88" y="250" font-size="78" font-weight="900" fill="#F8FAFC" font-family="PingFang SC, Noto Sans SC, Arial">FTH职业特质测评</text>
  <text x="88" y="332" font-size="58" font-weight="850" fill="#FACC15" font-family="PingFang SC, Noto Sans SC, Arial">小凡微信版</text>
  <text x="88" y="410" font-size="30" fill="#CBD5E1" font-family="PingFang SC, Noto Sans SC, Arial">看见你的三大特质排序，找到更适合的岗位与成长路径</text>
  ...
  <g filter="url(#shadow)">
    ...
    <g transform="translate(128 548)">
      ...
      <text x="28" y="122" font-size="20" fill="#CBD5E1" font-family="PingFang SC, Noto Sans SC, Arial">目标 · 行动 · 突破</text>
    </g>
    <g transform="translate(422 548)">
      ...
      <text x="28" y="122" font-size="20" fill="#CBD5E1" font-family="PingFang SC, Noto Sans SC, Arial">分析 · 结构 · 创造</text>
    </g>
    <g transform="translate(716 548)">
      ...
      <text x="28" y="122" font-size="20" fill="#CBD5E1" font-family="PingFang SC, Noto Sans SC, Arial">连接 · 支持 · 稳定</text>
    </g>
  </g>
  ...
  <g transform="translate(88 820)">
    ...
    <g transform="translate(0 50)">
      ...
      <text x="40" y="24" font-size="27" fill="#CBD5E1" font-family="PingFang SC, Noto Sans SC, Arial">三大特质排序：如 FTH / TFH / HFT</text>
    </g>
    <g transform="translate(0 104)">
      <circle cx="16" cy="15" r="8" fill="#FACC15"/>
      <text x="40" y="24" font-size="27" fill="#CBD5E1" font-family="PingFang SC, Noto Sans SC, Arial">六大分型画像：主分型、次分型、第三倾向</text>
    </g>
    <g transform="translate(0 158)">
      <circle cx="16" cy="15" r="8" fill="#FACC15"/>
      <text x="40" y="24" font-size="27" fill="#CBD5E1" font-family="PingFang SC, Noto Sans SC, Arial">岗位建议：匹配顾问、市场、老师、教练、教务等</text>
    </g>
  </g>
  ...
  <text x="128" y="1298" font-size="24" font-weight="800" fill="#F8FAFC" font-family="PingFang SC, Noto Sans SC, Arial">适合现场测评 / 团队复盘 / 岗位发展对话</text>
  <text x="128" y="1330" font-size="18" fill="#94A3B8" font-family="PingFang SC, Noto Sans SC, Arial">结果仅用于自我理解与发展沟通，不用于简单贴标签</text>
</svg>`;
