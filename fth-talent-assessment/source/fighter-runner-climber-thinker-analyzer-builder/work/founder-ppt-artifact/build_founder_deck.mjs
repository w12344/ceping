...
const ROOT = "/Users/chenpan/Documents/Codex/2026-06-09/fighter-runner-climber-thinker-analyzer-builder";
const OUT = path.join(ROOT, "outputs/FTH创业者职业特质测评.pptx");
const PREVIEW_DIR = "/var/folders/hn/2fszcvtd1v3f7p7l8m97zdzm0000gn/T/codex-presentations/manual-founder-fth/tmp/preview";
const LAYOUT_DIR = "/var/folders/hn/2fszcvtd1v3f7p7l8m97zdzm0000gn/T/codex-presentations/manual-founder-fth/tmp/layout";
const QA_DIR = "/var/folders/hn/2fszcvtd1v3f7p7l8m97zdzm0000gn/T/codex-presentations/manual-founder-fth/tmp/qa";
